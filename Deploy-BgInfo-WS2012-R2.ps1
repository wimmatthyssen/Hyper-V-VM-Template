...
A script used to download, install and configure the latest BgInfo version (v4.28) on a Windows Server 2012 R2. The BgInfo folder will be created on the C: drive if the folder does not already exist. 
